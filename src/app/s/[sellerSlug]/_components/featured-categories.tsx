        ...
        {categories.map((category, index) => {
          ...
          return (
            <Link
              ...
              className="group flex min-h-36 flex-col rounded-xl border border-slate-200 bg-white p-4 shadow-sm transition hover:-translate-y-1 hover:border-red-200 hover:shadow-lg"
            >
              <div className="mb-4 grid h-11 w-11 place-items-center rounded-xl bg-blue-50 text-[#0e4f94] group-hover:bg-red-50 group-hover:text-red-600">
                <Icon className="h-5 w-5" />
              </div>
              <div className="text-sm font-black text-[#092f5c]">{category.name}</div>
              ...
              <div className="mt-auto pt-3 text-[10px] font-bold text-red-600">
